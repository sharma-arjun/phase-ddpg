	...
	def weight_from_phase(self, phase, control_gru_list, control_h2o_list):
		...
		w = spline_w(phase)
        		...
        		for key in control_gru_list[0][0]._parameters.keys():
	        		weight[key+'_' + str(n)] = control_gru_list[n][kn(phase, 1)]._parameters[key].data + w*0.5*(control_gru_list[n][kn(phase, 2)]._parameters[key].data - control_gru_list[n][kn(phase, 0)]._parameters[key].data) + w*w*(control_gru_list[n][kn(phase, 0)]._parameters[key].data - 2.5*control_gru_list[n][kn(phase, 1)]._parameters[key].data + 2*control_gru_list[n][kn(phase, 2)]._parameters[key].data - 0.5*control_gru_list[n][kn(phase, 3)]._parameters[key].data) + w*w*w*(1.5*control_gru_list[n][kn(phase, 1)]._parameters[key].data - 1.5*control_gru_list[kn(phase, 2)]._parameters[key].data + 0.5*control_gru_list[kn(phase, 3)]._parameters[key].data - 0.5*control_gru_list[kn(phase, 0)]._parameters[key].data)

        	    for key in control_h2o_list[0]._parameters.keys():
	        	weight[key] = control_h2o_list[n][kn(phase, 1)]._parameters[key].data + w*0.5*(control_h2o_list[n][kn(phase, 2)]._parameters[key].data - control_h2o_list[n][kn(phase, 0)]._parameters[key].data) + w*w*(control_h2o_list[n][kn(phase, 0)]._parameters[key].data - 2.5*control_h2o_list[n][kn(phase, 1)]._parameters[key].data + 2*control_h2o_list[n][kn(phase, 2)]._parameters[key].data - 0.5*control_h2o_list[n][kn(phase, 3)]._parameters[key].data) + w*w*w*(1.5*control_h2o_list[n][kn(phase, 1)]._parameters[key].data - 1.5*control_h2o_list[kn(phase, 2)]._parameters[key].data + 0.5*control_h2o_list[kn(phase, 3)]._parameters[key].data - 0.5*control_h2o_list[kn(phase, 0)]._parameters[key].data)
